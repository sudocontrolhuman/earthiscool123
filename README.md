...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/earthiscool123)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/earthiscool123
```

A live public deployment of this template is available at [https://earthiscool123.templates.workers.dev](https://earthiscool123.templates.workers.dev)
